...
frappe.views.Container = Class.extend({
	...
	change_to: function(label) {
		...
		if(this.page && this.page != page) {
            console.log("hiding aguacate");
            $("#aguacate-container").html('');
            $(".aguacate-container").remove();
            $(this.page).find("#aguacate-container");
            //document.getElementById("aguacate-container").remove();
            console.log("aguacate-containe");
			$(this.page).hide();
		...
		if(!this.page || this.page != page) {
            $("#aguacate-container").html('');
            $(this.page).find(".aguacate-container").remove();
			this.page = page;
