// Copyright (c) 2021, Aguacate Labs
...
frappe.ui.Page = class Page {
	constructor(opts) {
		...
		this.fields_dict = {};
		this.views = {};
        this.template_page = '<div class="container page-body"> <div class="page-toolbar hide"> <div class="container"> </div> </div> <div class="page-wrapper"> <div class="page-content"> <div class="workflow-button-area btn-group pull-right hide"></div> <div class="clearfix"></div> </div> </div> </div>'
		...
		if (this.disable_sidebar_toggle || !sidebar_wrapper.length) {
			...
			sidebar_toggle.click(() => {
				if (frappe.utils.is_xs() || frappe.utils.is_sm()) {
                    ...
                    sidebar_wrapper.toggleClass("layout-side-section-sm");
                    $('.list-sidebar').toggleClass("list-sidebar-sm");
                    $('.standard-sidebar-label').toggle();
                    $('.sidebar-item-label').toggle();
                    $('.icon-md').toggleClass('icon-md-sidebar');
