...
class DesktopPage {
	...
	make() {
		this.page = $(`<div class="desk-page aguacate-desk" data-page-name=${this.page_name}></div>`);
        this.aguacate_custom_widget = $(`<div id="aguacate_custom_widget ${this.page_name}" class="aguacate_custom_widget"></div>`);
		this.page.append(frappe.render_template('workspace_loading_skeleton'));
        this.aguacate_custom_widget.appendTo(this.container);
